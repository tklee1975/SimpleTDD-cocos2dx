...
void ButtonTest::defineTests()
{
	ADD_TEST(testControlButton);
	ADD_TEST(testButtonStyle);
	ADD_TEST(testButtonClick);
	ADD_TEST(testButtonColor);
	ADD_TEST(testAlignItemsWithScroll);
	ADD_TEST(testAlignItems);
	ADD_TEST(testMenuLayout);
	ADD_TEST(testMenuStyle);
	ADD_TEST(testAlighColumn);
	ADD_TEST(testButtonColor);
	ADD_TEST(testControlButton);
}
...
void ButtonTest::testMenuLayout()
{
	log("testMenu");
	int count = 20;
...
void ButtonTest::testAlighColumn()
{
	int numCol = 3;
	int count = 100;
...
void ButtonTest::testAlignItems()
{
	int numCol = 3;
	int count = 100;
	Menu *menu = createMenu(count);
...
void ButtonTest::testAlignItemsWithScroll()
{
	int numCol = 3;
	int count = 100;
	Menu *menu = createMenu(count);
...
void ButtonTest::testControlButton()
{
...
void ButtonTest::testButtonColor()
{
...
void ButtonTest::testButtonClick()
{
...
void ButtonTest::testButtonStyle()
{
